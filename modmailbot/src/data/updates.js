  ...
  https.get(
    {
      ...
      headers: {
        'User-Agent': `BOT de ModMail (https://github.com/${owner}/${repo}) (${packageJson.version})`
      }
    },
    async res => {
      if (res.statusCode !== 200) {
        ...
        console.warn(`[ADVERTENCIA] Obtuvo el código de estado ${res.statusCode} al comprobar las actualizaciones disponibles`);
        return;
      }
